class Computadora:
    def __init__(self, procesador, ram, almacenamiento, sistema_operativo):
        ...
        self.__ram = ram  # en GB
        self.__almacenamiento = almacenamiento  # en GB
    ...
    def actualizar_sistema_operativo(self, nueva_version):
        ...
        if nueva_version == self.__sistema_operativo:
            print(f"Ya tienes la última versión: {nueva_version}.")
        else:
            print(f"Actualizando el sistema operativo de {self.__sistema_operativo} a {nueva_version}...")
            self.__sistema_operativo = nueva_version
    ...
    def optimizar_rendimiento(self):
        ...
        ram_liberada = self.__ram * 0.10
        self.__ram += ram_liberada
        print(f"Rendimiento optimizado. Se han liberado {ram_liberada} GB de RAM.")
        print(f"RAM actual disponible: {self.__ram} GB.")
    ...
    def __str__(self):
        ...
        return (f"Computadora:\n"
                f"- Procesador: {self.__procesador}\n"
                f"- RAM: {self.__ram} GB\n"
                f"- Almacenamiento: {self.__almacenamiento} GB\n"
                f"- Sistema Operativo: {self.__sistema_operativo}\n"
                f"- Estado: {estado}\n"
